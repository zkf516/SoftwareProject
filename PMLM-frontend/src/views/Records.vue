...
export default {
  ...
  data() {
    return {
      ...
      formFields: [
        { key: 'ph', label: '酸碱度', type: 'number' },
        { key: 'alb', label: '白蛋白', type: 'number' },
        { key: 'tp', label: '总蛋白', type: 'number' },
        { key: 'ibil', label: '间接胆红素', type: 'number' },
        { key: 'dbil', label: '直接胆红素', type: 'number' },
        { key: 'tbil', label: '总胆红素', type: 'number' },
        { key: 'alp', label: '碱性磷酸酶', type: 'number' },
        { key: 'alt', label: '丙氨酸氨基转移酶', type: 'number' },
        { key: 'prealb', label: '前白蛋白', type: 'number' },
        { key: 'tba', label: '总胆汁酸', type: 'number' },
        { key: 'lplt', label: '大血小板数目', type: 'number' },
        { key: 'pcrit', label: '血小板压积', type: 'number' },
        { key: 'lpr', label: '大血小板比率', type: 'number' },
        { key: 'mpv', label: '平均血小板体积', type: 'number' },
        { key: 'pdw', label: '血小板体积分布宽度', type: 'number' },
        { key: 'rdw_cv', label: '红细胞体积分布宽度变异系数', type: 'number' },
        { key: 'rdw_sd', label: '红细胞体积分布宽度标准差', type: 'number' },
        { key: 'baso_abs', label: '嗜碱性粒细胞绝对数', type: 'number' },
        { key: 'eos_abs', label: '嗜酸性粒细胞绝对数', type: 'number' },
        { key: 'mono_abs', label: '单核细胞绝对数', type: 'number' },
        { key: 'lymph_abs', label: '淋巴细胞绝对数', type: 'number' },
        { key: 'neut_abs', label: '中性粒细胞绝对数', type: 'number' },
        { key: 'baso_pct', label: '嗜碱性粒细胞比率', type: 'number' },
        { key: 'eos_pct', label: '嗜酸性粒细胞比率', type: 'number' },
        { key: 'mono_pct', label: '单核细胞比率', type: 'number' },
        { key: 'lymph_pct', label: '淋巴细胞比率', type: 'number' },
        { key: 'neut_pct', label: '中性粒细胞比率', type: 'number' },
        { key: 'mchc', label: '平均红细胞血红蛋白浓度', type: 'number' },
        { key: 'mch', label: '平均红细胞血红蛋白含量', type: 'number' },
        { key: 'hct', label: '血细胞比容', type: 'number' },
        { key: 'wbc', label: '白细胞计数', type: 'number' },
        { key: 'platelet', label: '血小板总数', type: 'number' },
        { key: 'hgb', label: '血红蛋白', type: 'number' },
        { key: 'mcv', label: '平均红细胞体积', type: 'number' },
        { key: 'rbc', label: '红细胞计数', type: 'number' }
      ],
      form: {
